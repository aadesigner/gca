...
import apiUsageRouter from "./admin/apiUsage";
import auditLogsRouter from "./admin/auditLogs";
import settingsRouter from "./admin/settings";
import emailSettingsRouter from "./admin/emailSettings";
...
import photoMirrorRouter from "./admin/photoMirror";
import seobukPhotosRouter from "./admin/seobukPhotos";
...
router.use(photoMirrorRouter);
router.use(seobukPhotosRouter);
