...
export const ENCAR_MODELS_BY_MAKE: Record<string, string[]> = {
  ...
  Mitsubishi: ["Outlander", "Eclipse Cross", "Pajero", "Lancer", "Triton"],
  Suzuki: ["Swift", "Jimny", "Vitara", "SX4"],
  Chrysler: ["300C", "Pacifica", "Voyager"],
  Dodge: ["Charger", "Challenger", "Durango", "Ram"],
  "Rolls-Royce": ["Ghost", "Phantom", "Wraith", "Cullinan", "Spectre", "Dawn"],
  "Aston Martin": ["DB11", "DB12", "Vantage", "DBS", "DBX"],
  McLaren: ["720S", "750S", "Artura", "GT", "570S"],
  Alpine: ["A110"],
  Maybach: ["S-Class", "GLS"],
  Smart: ["Fortwo", "#1", "#3"],
