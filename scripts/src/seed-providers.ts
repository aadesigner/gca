...
async function main() {
  ...
  const exporters: Array<[string, string, string, string, string, number, string, string]> = [
    ...
    ["AAA Auto SK", "aaaauto", "dealer", "SK", "https://www.aaaauto.sk", 25, "aaaauto-v1.0.0", "Slovak AAA Auto used cars. Angular SSR ng-state: VIN, mileage, photos, STK, history labels."],
